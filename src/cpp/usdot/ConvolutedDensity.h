...
public:
    ...
    /**/  ConvolutedDensity             ( TF beg_original_positions, TF end_original_positions, const VF &original_values );
    /**/  ConvolutedDensity             ( const VF &original_positions, const VF &original_values );
    /**/  ConvolutedDensity             ( const VF &original_values );
